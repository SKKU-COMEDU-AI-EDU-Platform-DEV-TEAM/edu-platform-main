        ...
        >
          {userTry == 1 ? (
            <>
              ...
              <br />
              <br />
              따라서 에듀버블스에서는 여러분의 학습 성향에 따른 학습자 친화적
              컨텐츠 제공을 위하여 본격적인 학습을 시작하기에 앞서 두 단계의
              설문조사(MBTI, 학습 상태 점검)를 진행하고자 합니다. 자신의 학습
              유형을 확인해보고 유형에 따라 제공되는 새로운 학습 환경을
              경험해보시기 바랍니다.
            </>
          ) : (
            <>
