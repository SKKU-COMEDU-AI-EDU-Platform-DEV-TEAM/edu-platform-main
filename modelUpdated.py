...
class User(db.Model):
    ...
    def __init__(self, email, pw, nName, usrType, cDate, uDate, mbti, kolbType, kolbProba, lrnStep, lrnLvl, lrnType, gamiLvl, gamiExp, usrTestTry):
    ...
    def __repr__(self):
        return '<User %r %r %r %r %r %r %r %r %r>' % (self.userNickname, self.userId, self.userEmail, self.userKolbType, self.userKolbProbability, self.userLearningStep, self.userLearningLevel, self.userLearnerType, self.userTestTry)
